                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-12 items-end">
                    <div className="lg:col-span-7">
                        ...
                        >
                            ...
                            <svg width="443" height="39" viewBox="0 0 443 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="text-[#0f172a] flex items-center gap-3 text-[28px] md:text-[44px]">Powerful
                                <svg width="42" height="45" viewBox="0 0 42 45" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-3">
